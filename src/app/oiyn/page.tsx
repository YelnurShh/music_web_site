...
export const metadata: Metadata = {
  ...
  description:
    "Қазақтың ұлттық аспаптары туралы интерактивті ойындар: викторина, «Жұп тап», аспаптарды тобына бөлу және сөз құрастыру.",
};
  ...
  return (
    <>
      <PageHero
        ...
        lead="Төрт ойын бар: білімді тексеретін викторина, есте сақтауды жаттықтыратын «Жұп тап», аспаптарды жіктейтін «Тобына бөл» және атауларды үйрететін «Сөз құрастыр». Барлығы тегін, тіркелудің қажеті жоқ."
      />
